...
// Character - Vanguard By T. Choonyung - https://www.mixamo.com/#/?query=vanguard&type=Character
fbxLoader.load('models/vanguard_t_choonyung.fbx', (object) => {
  ...
  // Animation- Samba - https://www.mixamo.com/#/?query=Samba&type=Motion%2CMotionPack
  fbxLoader.load('models/vanguard@samba.fbx', (object) => {
    ...
    // Animation - Belly Dancing - https://www.mixamo.com/#/?query=Belly+Dancing&type=Motion%2CMotionPack
    fbxLoader.load('models/vanguard@bellydance.fbx', (object) => {
      ...
      // Animation - Goofy Running - https://www.mixamo.com/#/?query=Goofy+Running&type=Motion%2CMotionPack
